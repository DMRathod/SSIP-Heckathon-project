...
$fname=$row['EmpFname'];
// echo $fname;
// $query=mysqli_query($con,"SELECT * from empLeave");
        ...
        <div class="row">
          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form class="user" name="register" method="post" action="leave1.php">
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" id="FirstName" name="FirstName" placeholder="First Name" pattern="[A-Za-z]+" required="true" value="<?php echo $fname;?>" disabled>
                    <input type="hidden" class="form-control form-control-user" id="FirstName" name="FirstName" placeholder="First Name" pattern="[A-Za-z]+" required="true" value="<?php echo $fname;?>" >
                  </div>
                  <div class="col-sm-6">
                    <input type="hidden" class="form-control form-control-user" id="eid" name="eid" placeholder="Employee ID"  required="true" value="<?php echo $empid;?>" >
                  </div>
                </div>
                 <div class="form-group">
                  <input type="text" class="form-control form-control-user" id="empcode" name="empcode" placeholder="Reason for leave"  required="true">
                </div>
                <div class="form-group">
                  <!-- <input type="email" class="form-control form-control-user" id="Email" name="Email" placeholder="Email Address" required="true"> -->
                  <textarea id="leave" name="leave" placeholder="description" style="text-" class="form-control form-control-user"></textarea>
                </div>
                <!-- <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
              ...
              <input type="submit" name="submit" value="Post leave" class="btn btn-primary btn-user btn-block">
