...
if(isset($_POST['login']))
  {
    ...
    if($ret>0){
     ...
     header('location:welcome.php');
      ...
      echo "Invalid !!! Please Enter Valid Details";
    }
  }
  ?>
...
<head>
  ...
  <!-- Custom styles for this template-->ō
...
<body style="background-color: grey;" >
  ...
  <div class="container">
      <h3 align="center" style="color: black; padding-top: 2%">Employee Attendance Record Keeping System <a href=""></h3>
                ...
                <div class="p-5">
                  ...
                  <form class="user" method="post" action="">
                    <div class="form-group">
                      <input type="test" class="form-control form-control-user" id="username" name="username" aria-describedby="emailHelp" required="true" placeholder="Admin username ...">
                    </div>
                    <div class="form-group">
