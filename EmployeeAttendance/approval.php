...
echo $empid;
// exit;
$query=mysqli_query($con,"select * from attendance where Eid=$empid");
$row=mysqli_fetch_array($query);
if($row>0)
{

?> -->
<p style="font-size:16px; color:green" align="center"> </p>
...
$empid=$_SESSION['uid'];
// echo $empid;
$sql = "select * from empLeave where approve = 1 AND ID = ".$empid."";
$query=mysqli_query($con,"select * from empLeave where approve = 1 AND ID = ".$empid."");
// echo $sql;
// exit;
// $row=mysqli_fetch_array($query);
