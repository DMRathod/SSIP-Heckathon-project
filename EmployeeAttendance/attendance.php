...
if(isset($_POST['login']))
{
  ...
  $que="select EmpEmail,EmpPassword from employeedetail where EmpEmail='$b'AND EmpPassword='$c';";
  ...
  if(mysqli_num_rows($result))
  {
    ...
    $query = "INSERT INTO attendance (Eid,Ename,Email) select ID,EmpFname,EmpEmail from employeedetail where  EmpEmail='$b'AND EmpPassword='$c';";
...
<body class="bg-gradient-primary">
  ...
  <div class="container">
    <h3 align="center" style="color: black; padding-top: 2%">Employee Attendance Record Keeping System</h3>
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Verify your details</h1>
                  </div>
                  <p style="font-size:16px; color:red" align="center">  </p>
                  <form class="user" method="post" action="attendance.php">
                    ...
                    <p> <input type="submit" class="btn btn-primary btn-user btn-block" name="login" value="Go">                      
                    </p>
